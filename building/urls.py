...
urlpatterns = patterns('',
    ...
    url(r'^manage/setting/department/add/$', setting_department_add),
    url(r'^manage/setting/department/change/$', setting_department_change),
    url(r'^manage/setting/department/delete/$', setting_department_delete),
