...
class ElectricityInfo(models.Model):
    ...
    usageCapacityRevised = models.IntegerField()
    standardFeeApplied = models.IntegerField()
    tvLicenseFee = models.IntegerField()
    usageFee = models.IntegerField()
    chargedFee = models.IntegerField()
...
class GasInfo(models.Model):
    ...
    unitCostApplied = models.IntegerField()
    checkDay = models.DateField()
    checkCapacity = models.IntegerField()
    usageCapacity = models.IntegerField()
    usageCapacityRevised = models.IntegerField()
...
class WaterInfo(models.Model):
    ...
    usageCapacity = models.IntegerField()
    usageCapacityRevised = models.IntegerField()
    standardFee = models.IntegerField()
    standardFeeApplied = models.IntegerField()
    waterSupply30 = models.IntegerField()
    waterSupply40 = models.IntegerField()
    waterSupply50 = models.IntegerField()
    waterSupply100 = models.IntegerField()
    waterSupplyAll = models.IntegerField()
    sewerage30 = models.IntegerField()
    sewerage50 = models.IntegerField()
    sewerage100 = models.IntegerField()
    sewerageAll = models.IntegerField()
    waterUsageChargeFee = models.IntegerField()
    chargedFee = models.IntegerField()
